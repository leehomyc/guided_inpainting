...
python -m inpainting.train --name coco_inpainting_256_dilation_2_exp1_unguided_no_interpolated_conv_no_dilationn_with_perceptual --gpu_ids 2 --checkpoints_dir /home/xiaofen2/harry/guided_inpainting/log --loadSize 286 --fineSize 256 --label_nc 0 --dataroot /home/datasets/COCO_2017/train2017 --model inpainting_unguided --no_instance --resize_or_crop resize_and_crop --tf_log --batchSize 8 --keep_hole_only --ann_path '/home/datasets/COCO_2017/annotations/instances_train2017.json' --use_perceptual
