...
class InpaintingDatasetADE20kPredictSegmentation(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        image_annpath = '{}_seg.png'.format(basename)
        seg = scipy.misc.imread(image_annpath, mode='RGB')
        ...
        input_image = np.copy(image_seg_resized)
        input_image[mask_resized == 1] = 0
        # mask_resized = np.tile(mask_resized, (3, 1, 1))
    ...
    def name(self):
        return 'InpaintingDatasetADE20kPredictSegmentation'
