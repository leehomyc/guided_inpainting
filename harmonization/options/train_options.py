# ## Copyright (C) 2017 NVIDIA Corporation. All rights reserved. ## Licensed
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_epoch_freq', type=int, default=10,
                                 help='frequency of saving checkpoints at the '
                                      'end of epochs')
        self.parser.add_argument('--no_html', action='store_true',
                                 help='do not save intermediate training '
                                      'results to [opt.checkpoints_dir]/['
                                      'opt.name]/web/')
        self.parser.add_argument('--debug', action='store_true',
                                 help='only do one epoch and displays at each '
                                      'iteration')
        ...
        self.parser.add_argument('--which_epoch', type=str, default='latest',
                                 help='which epoch to load? set to latest to '
        ...
        self.parser.add_argument('--niter_decay', type=int, default=100,
                                 help='# of iter to linearly decay learning '
                                      'rate to zero')
