...
from inpainting_harmonization_test.util import util
...
class BaseOptions:
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--harm_checkpoints_dir', type=str,
                                 default='./checkpoints',
                                 help='harmonization models are saved here')
        ...
        self.parser.add_argument('--resize_or_crop', type=str,
                                 default='scale_width', help='scaling and cropping of images at load time [resize_and_crop|crop|scale_width|scale_width_and_crop]')
        self.parser.add_argument('--serial_batches', action='store_true',
                                 help='if true, takes images in order to make '
        ...
        self.parser.add_argument('--max_dataset_size', type=int,
                                 ...
                                 help='Maximum number of samples allowed per '
                                      'dataset. If the dataset directory '
