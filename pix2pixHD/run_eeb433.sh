...
# inpainting and keep hole only. coco_no_guided_inpainting_256_interpolated_conv_random_location 			exp 1
python -m inpainting.train --name coco_no_guided_inpainting_256_random_location_exp1 --gpu_ids 0 --checkpoints_dir /home/eeb433/Documents/Yuhang/guided_inpainting/inpainting/log --loadSize 286 --fineSize 256 --label_nc 0 --dataroot /media/eeb433/Storage/Dataset/MSCOCO/train2017 --model inpainting --no_instance --resize_or_crop resize_and_crop --tf_log --batchSize 8 --keep_hole_only --overlapPred 0 --interpolated_conv --dilation 2 --random_location
